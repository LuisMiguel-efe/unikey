...
HardwareSerial mySerial(2); // Usamos Serial2 en ESP32 (pines RX = IO16, TX = IO17)
...
void setup()
{
  ...
  // Configuramos Serial2 para el sensor de huellas
  mySerial.begin(57600, SERIAL_8N1, 16, 17); // RX = IO16, TX = IO17

  // Verificamos la conexión con el sensor
...
void loop() {
  getFingerprintID();
  delay(50);  // No es necesario correr esto a máxima velocidad
}
